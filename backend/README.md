...
## Project Structure
    ...
    ├── ideapros_complete_m_33814  # Django project configurations
...
1. Clone this repo and `cd ideapros_complete_m_33814`
...
2. Clone this repo and `cd ideapros_complete_m_33814`
